...
byte redPin = 11;          // pin alocar pentru led-ul rosu
byte greenPin = 9;         // pin alocat pentru led-ul verde
byte yellowPin = 10;       // pin alocat pentru led-ul galben
byte whitePin = 8;         // pin alocat led-ului alb
